...
triangle_numbers = generate_triangle_numbers(max_limit)

while percentage_improvement >= 1 / max_limit and items_checked <= len(triangle_numbers):
    for n in triangle_numbers:
        for m in triangle_numbers:
            new_estimate = n / m
